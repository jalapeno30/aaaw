...
public class Status implements Serializable {
    ...
    private Integer userStatusesId;
    @Basic(optional = false)
    ...
    public Status(Integer userStatusesId) {
        this.userStatusesId = userStatusesId;
    }

    public Status(Integer userStatusesId, String userStatusesName) {
        this.userStatusesId = userStatusesId;
        this.userStatusesName = userStatusesName;
    }

    public Integer getUserStatusesId() {
        return userStatusesId;
    }

    public void setUserStatusesId(Integer userStatusesId) {
        this.userStatusesId = userStatusesId;
    }
