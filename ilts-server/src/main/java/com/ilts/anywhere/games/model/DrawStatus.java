...
public class DrawStatus implements Serializable {
    ...
    @JoinColumn(name = "draw_id", referencedColumnName = "draw_id")
    ...
    public DrawStatus(Integer drawStatusId) {
        this.drawStatusId = drawStatusId;
    }

    public DrawStatus(Integer drawStatusId, java.util.Date created, boolean deleted) {
        this.drawStatusId = drawStatusId;
        this.created = created;
        this.deleted = deleted;
    }

    public Integer getDrawStatusId() {
        return drawStatusId;
    }

    public void setDrawStatusId(Integer drawStatusId) {
        this.drawStatusId = drawStatusId;
    }
