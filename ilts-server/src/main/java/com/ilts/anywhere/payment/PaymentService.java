...
public class PaymentService {
	...
	public Boolean hasFunding(ArrayList<Integer> orderID, String date, int userId) {
	...
	public String paypalFunding(ArrayList<Integer> orderID, String date, int userId) {
