...
public class CartController {
	...
	public @ResponseBody Object addOrder(
			...
			HttpServletResponse response) {
		             System.out.println("******/cart/addOrder *************"+jsonRequest);
...
////        return new ResponseEntity<Response>(ret, HttpStatus.OK);
	...
	public @ResponseBody ResponseEntity<List<Order>> getAllOrders(
			@RequestParam(value="token", required = true) String token,
			HttpServletResponse response) {
			System.out.println("******/cart/getAllOrders *************"+token);
...
////        return new ResponseEntity<Response>(ret, HttpStatus.OK);
	...
	public @ResponseBody Object getOrder(
			...
			@RequestParam(value="token", required=true) String token,
			HttpServletResponse response) {
            			System.out.println("******/cart/getOrder *************"+token);
	...
	public @ResponseBody Object removeOrder(
			@PathVariable("id") int id,
			HttpServletResponse response) {
		            			System.out.println("******/cart/removeOrder/{id} *************"+id);
